...
def initdb():
   ...
   #Generate test contact list
    ...
    sendMessage(1, "Test Messageayererer111222323")
    sendMessage(1, "Test Messageayererer111222323")
    sendMessage(1, "Test Messageayererer1112224343")
    sendMessage(1, "Test Messageayererer1112224343")
    sendMessage(2, "Test Messageayerererxzc")
    sendMessage(2, "zxczsc")
    sendMessage(2, "Testasdasdssage")
    sendMessage(2, "Test Mewrweressage")
